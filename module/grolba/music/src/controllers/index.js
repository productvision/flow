app.controller('grolba.music.IndexController', [
    "$sce", '$scope',
    function ($sce, $scope) {
        $scope.API = null;
        $scope.active = 0;
        ...
        $scope.audios = [
            {
                title: "1. Lentement",
                artist: "Miaow",
                poster: "module/grolba/music/public/img/b0.jpg",
                sources: [
                    {
            ...
            },
            {
                title: "2. Bubble",
                artist: "Miaow",
                poster: "module/grolba/music/public/img/b1.jpg",
                sources: [
                    {
            ...
            },
            {
                title: "3. Partir",
                artist: "Miaow",
                poster: "module/grolba/music/public/img/b2.jpg",
                sources: [
                    {
        ...
        $scope.video = {
            ...
            plugins: {
                ...
                poster: "module/grolba/music/public/img/c1.jpg"
            }
        };
